...
const Loading = () => {
	return (
		<div className="w-full h-screen pt-24 p-8 flex flex-col gap-4">
			{/* Detail Post */}
			<div className="border-2 border-black p-4 shadow-neu rounded-lg bg-lime-200 h-1/2 flex flex-col gap-4">
